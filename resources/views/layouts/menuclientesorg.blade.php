...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body>
        ...
        <ul class="list-unstyled components mb-5">
          <li class="active">
            <a href="mispolizas"><span class="fa fa-home mr-3"></span> Mis polizas</a>
          </li>
          <li class="active">
            <a href="missninestros"><span class="fa fa-home mr-3"></span> Siniestros</a>
          </li>
          <li class="active">
            <a href="mispagos"><span class="fa fa-home mr-3"></span> Pagos</a>
          </li>
          <li class="active">
            <a href="misdatos"><span class="fa fa-home mr-3"></span> Datos</a>
          </li>
          <li>
