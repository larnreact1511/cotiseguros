...
<head>
    ...
    <div id="navbar">
        <nav 
          class="navbar navbar-expand-lg navbar-light sticky-top bg-white shadow-sm position-sticky">
            <div 
              class="container">
                <a class="navbar-brand" href="/">
                    <img 
                      height="30" 
                      src="https://cotiseguros.com.ve/storage/LOGO%20RGB_Color%20-%20copia%20-%20copia%20(1).png" 
                      alt=""
                    >
                </a>
                  <span 
                    ...
                    style="color: rgba(0, 0, 0, 0.5); font-size: 10px;">
                      Nuestra experiencia... es tu tranquilidad...!
                  </span>
                  <button 
                  ...
                  <div 
                      ...
                      <ul class="navbar-nav me-auto mb-2 mb-lg-0"></ul>
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a 
                                  class="nav-link mon-bold fs-7 mx-3" 
                                  href="/adminclientes">
                                    Documentos
                                </a>
                            </li>
                            ...
                            <li 
                              class="nav-item">
                              <a 
                                class="nav-link btn btn-secondary text-white mon-bold fs-7 mx-3 px-4" 
                                href="{{ route('logout') }}">
                                  salir
                              </a>
                            </li>
    ...
    <div class="position-fixed w-100 h-100 top-0" style="display: none;z-index:10000000;" id="menu" data-menu="0">
        <div class="w-100 h-100 bg-white shadow-sm d-flex flex-column pt-3">
            ...
            <div class="w-100 px-5 py-3 mon-bold">
                <a href="{{ route('logout') }}" type="button" class="btn bg-pink text-white mon-bold rounded-pill">Salir</a>
