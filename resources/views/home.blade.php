  ...
  <div id="navbar"></div>
                  ...
                  <div class="w-50 p-2 text-center">
                    <img src="{{ asset('storage/' . $item->imagen) }}" alt="">
                      ...
                      <div 
                        ...
                        class="p-3 bg-pink rounded-pill text-decoration-none text-white mt-3 text-center">{{ $item->boton }}
                      </div>
                  </div>
    ...
    <div class="container">
      <div class="row p-2 m-2">
        <div class="col-md-6 justify-content-center text-center" style="cursor:pointer;" >
          <img src="https://dev.cotiseguros.com.ve/Sin-título-2Llamada.png" >
        </div>
        <div class="col-md-6 justify-content-center text-center" onclick="location.href='https://wa.me/584247089641'" style="cursor:pointer;" >
          <img src="https://dev.cotiseguros.com.ve/Sin-título-2whatsAPP.png" >
        </div>
      </div>
    </div>
    <!-- Noveno Slide -->
