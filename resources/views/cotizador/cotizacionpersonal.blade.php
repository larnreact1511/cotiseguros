    ...
    <div class="container my-5">
        ...
        <div id="cotizacionpesonal" class="my-5">
            <div class="row bg-light py-4 px-5 rounded shadow mx-2">
                ...
                <div class="col-12 col-md-3 mt-3 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <input type="hidden" id="idquote" name="idquote" value="" readonly>
                </div> 
            </div>
            <!-- -->
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="my-5">
                                <h1 class="mon-black text-danger display-6 text-start my-3">PERSONAS A ASEGURAR 11</h1>
                            <div 
                                id ="divparientes"
                                class="row"
                            >
                    ...
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    <div class="my-5">
                                        <h1 class="mon-black text-danger display-6 text-start my-3">PDFS GENERADOS</h1>
        ...
        <div class="modal fade show" id="exampleModal3" tabindex="-1" aria-modal="true" role="dialog" style="display: none;">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <div class="text-uppercase mon-black text-wine text-center" style="margin:auto;" id="titulocomparativo" name="titulocomparativo">
                            Cobertura de
                        </div>
                        <button 
                            type="button" 
                    ...
                    <div class="modal-body  justify-content-center" id="divcomparar" name="divcomparar">
    ...
    <script> 
        ...
        function buscarprimas2()
        {
            ...
            .then((data) => 
            {
                ...
                else 
                {
                    ...
                    $("#idquote").val(data.idquote);
                    //console.log('todo',insurerCoverage)
                    quoteid = data.id; 
        ...
        function generartodonuevo()
        {
            ...
            .then(r => 
            {
                ...
                if (r.ruta)
                {
                    ...
                    r.ruta.map((r,indexr)=>
                    {   
                        htmlbotones +=` <a class="btn btn-light rounded-pill mon-regular p-3" href="${r}" target="_blank" > Ver PDF nro  -${indexr +1 }</a>`;
                    });
        ...
        function changeFrequency(nombre,frecuency)
        {
            ...
            insurerCoverage.map((ic,indexInsurerCoverage) =>
            {
                ...
                total = Math.round(total); console.log(total);
        ...
        function cuadrocomparativo()
        {
            ...
            $("#titulocomparativo").html(''); // new Intl.NumberFormat().format(valorc)
        ...
        function generartrimestral(id)
        {
            ...
            comparativo[id].miembrostrimesral.map((c,indexcomparativo) =>
            {
